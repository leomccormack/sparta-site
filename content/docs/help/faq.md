...
## Why are the VST3 versions of the plug-ins limited to 24 or 64 channels?

This is a known issue with the VST3 SDK, and is why we recommened that you use either the VST or LV2 versions of the plug-ins instead.
